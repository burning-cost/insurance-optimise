"""
Upload insurance-optimise and run pytest (including new test_model_quality.py)
...
# MAGIC %md
# MAGIC # insurance-optimise v0.3.4 -- pytest run (model_quality module)
...
notebook_path = f"{WORKSPACE_DIR}/run_model_quality_tests"
w.workspace.import_(
    path=notebook_path,
...
submit_resp = w.jobs.submit(
    run_name="insurance-optimise-v0.3.4-model-quality-pytest",
    tasks=[
        jobs.SubmitTask(
            task_key="pytest",
